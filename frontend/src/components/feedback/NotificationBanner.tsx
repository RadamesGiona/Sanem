...
const NotificationBanner: React.FC<NotificationBannerProps> = ({
    ...
    useEffect(() => {
        ...
        if (visible) {
            ...
            // autoclose chama onClose corretamente
            ...
            // Apenas anima — NÃO CHAMA onClose AQUI!
            Animated.parallel([
                Animated.timing(translateY, {
    ...
    const renderIcon = () => {
        if (icon) return <View style={styles.icon}>{icon}</View>;
    ...
    if (!visible && opacityValue.current === 0) return null;
